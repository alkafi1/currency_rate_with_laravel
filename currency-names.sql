...
CREATE TABLE IF NOT EXISTS `currencies_codes` (
...
-- https://www.html-code-generator.com/mysql/currency-names
-- Dumping data for table `currency`

INSERT INTO `currencies_codes` (`id`, `currency_code`, `currency_name`) VALUES
